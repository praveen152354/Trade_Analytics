...
both hit the same live Snowflake account, just from a fully local control
plane (Airflow, dbt, the generator script all run on your machine;
Snowflake stays the only cloud dependency):
